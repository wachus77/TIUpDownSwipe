...
class GripperView: UIView {
    ...
    private lazy var allLayers: [CAShapeLayer] = {
        return [self.line1Layer, self.line2Layer]
    }()
    ...
    func animate(minusHeight: CGFloat) {
        self.setup(center: gCenter, size: gSize, heightRatio: gHeightRatio, offset: gOffset, lineWidth: lineWidth, type: type, minusHeight: minusHeight)
    }
}
